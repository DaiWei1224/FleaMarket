...
public class EditCommodityActivity extends AppCompatActivity implements IServerListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        commodityDetail.setText(commodity.getCommodityDetail());
                ...
                .setPositiveButton("确定", (dialog, which) -> {
                        ...
                        if (havePhoto) {
                            ...
                            if (changePhoto) {
                                ...
                                byte[] data = PictureUtils.loadImageFromFile(new File(getExternalCacheDir().getAbsolutePath() + "post_image.jpg"));
                                PictureUtils.saveImageFromByte(data, getExternalCacheDir().getAbsolutePath() +
                                        "/commodity/" + commodity.getCommodityID() + ".jpg");
                            } else {
                                netImage.setData(PictureUtils.loadImageFromFile(
